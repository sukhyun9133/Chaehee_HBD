...
const pages = [
  ...
  { question: "주말엔 같이 장 보고 내가 요리할게! 혹시 망해도 맛있게 먹어줄 수 있어? 🍳😆" },
  ...
  { question: "퇴근하고는 같이 밥 먹으면서 오늘 어땠는지 얘기 어때? 채희 이야기 듣는 게 제일 좋거든 😆🍚" },
  ...
  { question: "앞으로 평생 ‘채희 편’만 들 건데 각오돼 있지? 물론 이미 나는 채희만의 편이긴 해 😎❤️",image: "final.jpg"},
  {
    type: "confess",
    content: [
      "이 모든 상상들이",
